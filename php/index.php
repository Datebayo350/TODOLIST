...
<body>
    ...
    <main>
        <div class="ancestor container mt-3" style="max-height: 450px; overflow-y:scroll">
            <div class="parent container mt-3 p-3 shadow-complete">
                <div class="row d-flex justify-content-around">
                    <div class="title w-75 d-flex justify-content-between">
                        <p class="task-paragraph">Acheter du pain</p>
                        <input type="text" class="task-input form-control w-25 d-none" aria-label="Small">    
                        <p class="task-paragraph">Nom de la catégorie</p>
                        <input type="text" class="task-input form-control w-25 d-none " aria-label="Small">    
                    </div>
                    <div lass="d-flex justify-content-evenly">
                    ...
                    <div class="mb-n2 mt-2 p-0 progress container">
            ...
            <div class="parent container mt-3 p-3 shadow-started">
                <div class="row d-flex justify-content-around">
                    <div class="title w-75 d-flex justify-content-between">
                        <p class="task-paragraph">Acheter du pain</p>
                        <input type="text" class="task-input form-control w-25 d-none" aria-label="Small">    
            ...
            <div class="parent container mt-3 p-3 shadow-incomplete">
                <div class="row d-flex justify-content-around">
                    <div class="title w-75 d-flex justify-content-between">
                        <p class="task-paragraph">Acheter du pain</p>
                        <input type="text" class="task-input form-control w-25 d-none" aria-label="Small">    
        ...
        <form action="" method="post" class="p-1 mt-5 container form">
        ...
        <template id="template">
            <div class="parent container mt-3 p-3">
                <div class="row d-flex justify-content-around">
                    <div class="title w-75 d-flex justify-content-between">
                        <p class="task-paragraph templateTitle_task"></p>
                        <input type="text" class="task-input form-control w-25 d-none" aria-label="Small">    
                        <p class="task-paragraph templateCategory_task"></p>
                        <input type="text" class="task-input form-control w-25 d-none " aria-label="Small">    
                    </div>
                    <div lass="d-flex justify-content-evenly">
                        <button><span class="check  fas fa-check-square" style="color: Dodgerblue" id="button1"></span></button>
